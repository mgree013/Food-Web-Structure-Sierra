...
setwd("~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO")
getwd()
#EVO ELS2_1
EVO.ELS2_1<-food.web%>%
...
EVO.food.web.ELS2_1<-food.web%>%
  filter(Network=="EVO"& Site=="ELS2_1")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS2_1<-left_join(EVO.ELS2_1,EVO.food.web.ELS2_1)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS2_1)<-EVO.ELS2_1$Taxonomic_name
...
nodes<-cbind(EVOs.ELS2_1,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS2_1, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS2_1/",fn='write.csv' )
...
EVO.food.web.ELS2_2<-food.web%>%
  filter(Network=="EVO"& Site=="ELS2_2")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS2_2<-left_join(EVO.ELS2_2,EVO.food.web.ELS2_2)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS2_2)<-EVO.ELS2_2$Taxonomic_name
...
nodes<-cbind(EVOs.ELS2_2,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS2_2, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS2_2/",fn='write.csv' )
...
EVO.food.web.ELS2_3<-food.web%>%
  filter(Network=="EVO"& Site=="ELS2_3")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS2_3<-left_join(EVO.ELS2_3,EVO.food.web.ELS2_3)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS2_3)<-EVO.ELS2_3$Taxonomic_name
...
nodes<-cbind(EVOs.ELS2_3,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS2_3, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS2_3/",fn='write.csv' )
...
EVO.food.web.ELS3_1<-food.web%>%
  filter(Network=="EVO"& Site=="ELS3_1")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS3_1<-left_join(EVO.ELS3_1,EVO.food.web.ELS3_1)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS3_1)<-EVO.ELS3_1$Taxonomic_name
...
nodes<-cbind(EVOs.ELS3_1,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS3_1, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS3_1/",fn='write.csv' )
...
EVO.food.web.ELS3_2<-food.web%>%
  filter(Network=="EVO"& Site=="ELS3_2")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS3_2<-left_join(EVO.ELS3_2,EVO.food.web.ELS3_2)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS3_2)<-EVO.ELS3_2$Taxonomic_name
...
nodes<-cbind(EVOs.ELS3_2,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS3_2, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS3_2/",fn='write.csv' )
...
#CLS3.2
EVO.CLS3.2<-food.web%>%
  filter(Network=="EVO" & Site=="CLS3_2")%>%
  distinct(Taxonomic_name, .keep_all = TRUE )

EVO.food.web.CLS3.2<-food.web%>%
  filter(Network=="EVO"& Site=="CLS3_2")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.CLS3.2<-left_join(EVO.CLS3.2,EVO.food.web.CLS3.2)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.CLS3.2)<-EVO.CLS3.2$Taxonomic_name
...
nodes<-cbind(EVOs.CLS3.2,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.CLS3.2, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/CLS3.2/",fn='write.csv' )

EVOs.LS.CLS3.2 <- Community(properties = CPS(EVO.CLS3.2),
                                nodes = EVOs.CLS3.2,
                                trophic.links = links)

PlotWebByLevel(EVO.CLS3.2, level='ChainAveragedTrophicLevel')
...
EVO.food.web.ELS3_3<-food.web%>%
  filter(Network=="EVO"& Site=="ELS3_3")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS3_3<-left_join(EVO.ELS3_3,EVO.food.web.ELS3_3)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS3_3)<-EVO.ELS3_3$Taxonomic_name
...
nodes<-cbind(EVOs.ELS3_3,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS3_3, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS3_3/",fn='write.csv' )
...
EVO.food.web.ELS4_1<-food.web%>%
  filter(Network=="EVO"& Site=="ELS4_1")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS4_1<-left_join(EVO.ELS4_1,EVO.food.web.ELS4_1)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS4_1)<-EVO.ELS4_1$Taxonomic_name
...
nodes<-cbind(EVOs.ELS4_1,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS4_1, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS4_1/",fn='write.csv' )
...
EVO.food.web.ELS4_2<-food.web%>%
  filter(Network=="EVO"& Site=="ELS4_2")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS4_2<-left_join(EVO.ELS4_2,EVO.food.web.ELS4_2)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS4_2)<-EVO.ELS4_2$Taxonomic_name
...
nodes<-cbind(EVOs.ELS4_2,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS4_2, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS4_2/",fn='write.csv' )
...
EVO.food.web.ELS4_3<-food.web%>%
  filter(Network=="EVO"& Site=="ELS4_3")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS4_3<-left_join(EVO.ELS4_3,EVO.food.web.ELS4_3)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS4_3)<-EVO.ELS4_3$Taxonomic_name
...
nodes<-cbind(EVOs.ELS4_3,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS4_3, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS4_3/",fn='write.csv' )
...
EVO.food.web.ELS5_1<-food.web%>%
  filter(Network=="EVO"& Site=="ELS5_1")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS5_1<-left_join(EVO.ELS5_1,EVO.food.web.ELS5_1)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS5_1)<-EVO.ELS5_1$Taxonomic_name
...
nodes<-cbind(EVOs.ELS5_1,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS5_1, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS5_1/",fn='write.csv' )
...
EVO.food.web.ELS5_2<-food.web%>%
  filter(Network=="EVO"& Site=="ELS5_2")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS5_2<-left_join(EVO.ELS5_2,EVO.food.web.ELS5_2)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS5_2)<-EVO.ELS5_2$Taxonomic_name
...
nodes<-cbind(EVOs.ELS5_2,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS5_2, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS5_2/",fn='write.csv' )
...
EVO.food.web.ELS5_3<-food.web%>%
  filter(Network=="EVO"& Site=="ELS5_3")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS5_3<-left_join(EVO.ELS5_3,EVO.food.web.ELS5_3)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS5_3)<-EVO.ELS5_3$Taxonomic_name
...
nodes<-cbind(EVOs.ELS5_3,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS5_3, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS5_3/",fn='write.csv' )
...
EVO.food.web.ELS6_1<-food.web%>%
  filter(Network=="EVO"& Site=="ELS6_1")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS6_1<-left_join(EVO.ELS6_1,EVO.food.web.ELS6_1)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS6_1)<-EVO.ELS6_1$Taxonomic_name
...
nodes<-cbind(EVOs.ELS6_1,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS6_1, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS6_1/",fn='write.csv' )
...
EVO.food.web.ELS6_2<-food.web%>%
  filter(Network=="EVO"& Site=="ELS6_2")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS6_2<-left_join(EVO.ELS6_2,EVO.food.web.ELS6_2)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS6_2)<-EVO.ELS6_2$Taxonomic_name
...
nodes<-cbind(EVOs.ELS6_2,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS6_2, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS6_2/",fn='write.csv' )
...
EVO.food.web.ELS6_3<-food.web%>%
  filter(Network=="EVO"& Site=="ELS6_3")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS6_3<-left_join(EVO.ELS6_3,EVO.food.web.ELS6_3)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS6_3)<-EVO.ELS6_3$Taxonomic_name
...
nodes<-cbind(EVOs.ELS6_3,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS6_3, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS6_3/",fn='write.csv' )
...
EVO.food.web.ELS7_1<-food.web%>%
  filter(Network=="EVO"& Site=="ELS7_1")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS7_1<-left_join(EVO.ELS7_1,EVO.food.web.ELS7_1)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS7_1)<-EVO.ELS7_1$Taxonomic_name
...
nodes<-cbind(EVOs.ELS7_1,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS7_1, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS7_1/",fn='write.csv' )
...
EVO.food.web.ELS7_2<-food.web%>%
  filter(Network=="EVO"& Site=="ELS7_2")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS7_2<-left_join(EVO.ELS7_2,EVO.food.web.ELS7_2)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS7_2)<-EVO.ELS7_2$Taxonomic_name
...
nodes<-cbind(EVOs.ELS7_2,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS7_2, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS7_2/",fn='write.csv' )
...
EVO.food.web.ELS7_3<-food.web%>%
  filter(Network=="EVO"& Site=="ELS7_3")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS7_3<-left_join(EVO.ELS7_3,EVO.food.web.ELS7_3)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS7_3)<-EVO.ELS7_3$Taxonomic_name
...
nodes<-cbind(EVOs.ELS7_3,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS7_3, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS7_3/",fn='write.csv' )
...
EVO.food.web.ELS8_1<-food.web%>%
  filter(Network=="EVO"& Site=="ELS8_1")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS8_1<-left_join(EVO.ELS8_1,EVO.food.web.ELS8_1)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS8_1)<-EVO.ELS8_1$Taxonomic_name
...
nodes<-cbind(EVOs.ELS8_1,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS8_1, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS8_1/",fn='write.csv' )
...
EVO.food.web.ELS8_2<-food.web%>%
  filter(Network=="EVO"& Site=="ELS8_2")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS8_2<-left_join(EVO.ELS8_2,EVO.food.web.ELS8_2)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS8_2)<-EVO.ELS8_2$Taxonomic_name
...
nodes<-cbind(EVOs.ELS8_2,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS8_2, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS8_2/",fn='write.csv' )
...
EVO.food.web.ELS8_3<-food.web%>%
  filter(Network=="EVO"& Site=="ELS8_3")%>%
  dplyr::group_by(Taxonomic_name )%>%
  summarize(density=mean(value))

EVOs.ELS8_3<-left_join(EVO.ELS8_3,EVO.food.web.ELS8_3)%>%
  select(density, phylum ,class, order, family, genus, node)
row.names(EVOs.ELS8_3)<-EVO.ELS8_3$Taxonomic_name
...
nodes<-cbind(EVOs.ELS8_3,minimum.res.method,minimum.con.method)
...
SaveCommunity(EVO.ELS8_3, dir ="~/Dropbox/Sierra Lake Project/Food.Webs/MDG.Web/Sierra.Nevada.LS.Food.Web/Sites/EVO/Site/ELS8_3/",fn='write.csv' )
